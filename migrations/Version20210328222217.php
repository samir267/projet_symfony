 ...
 */
final class Version20210328222217 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, code_clt INT DEFAULT NULL, des_clt VARCHAR(100) DEFAULT NULL, adr_clt VARCHAR(100) DEFAULT NULL, tel_clt INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, code_clt_cde_id INT DEFAULT NULL, nul_cde INT DEFAULT NULL, date_cde DATE DEFAULT NULL, heure_cde INT DEFAULT NULL, remise_cde INT DEFAULT NULL, mnt_cde VARCHAR(100) DEFAULT NULL, INDEX IDX_6EEAA67DC10EE90D (code_clt_cde_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fournisseur (id INT AUTO_INCREMENT NOT NULL, code_four INT DEFAULT NULL, des_four VARCHAR(100) DEFAULT NULL, adr_four VARCHAR(100) DEFAULT NULL, contact_four VARCHAR(100) DEFAULT NULL, tel_four INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jouet (id INT AUTO_INCREMENT NOT NULL, code_four_jouet_id INT NOT NULL, code_jouet INT DEFAULT NULL, des_jouet VARCHAR(100) DEFAULT NULL, qte_stock_jouet INT DEFAULT NULL, pu_jouet VARCHAR(100) DEFAULT NULL, INDEX IDX_6B3DFFD85D20E737 (code_four_jouet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
